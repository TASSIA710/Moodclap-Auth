...
if ($PAYLOAD->sorting < AuthManager::getCurrentUser()->getGroup()->getSortPermission() + 1) {
	$RESPONSE->success = false;
	$RESPONSE->message = 'Sorting (min val) = ' . (AuthManager::getCurrentUser()->getGroup()->getSortPermission() + 1);
	return;
}
...
// Edit group
$GROUP->setSortPermission($PAYLOAD->sorting);
